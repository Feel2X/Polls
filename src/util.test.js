...
describe("limitStringLength", () => {
    it("will limit a string which is too long to the given length", () => {
...
describe("padTo2Digits", () => {
    ...
    it("will not pad a number of two digits with additional zeros but return original number as string", () => {
        const testNum = 10
...
describe("sortByTimestamp", () => {
    it("will sort an array of objects correctly by their timestamp in descending order", () => {
